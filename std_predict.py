...
if __name__ == "__main__":
    ...
    # Check the scenario
    if args.ds == "CBR+MB":
        model = std_models.Baseline_cbr_mb()
    elif args.ds == "MB":
        model = std_models.Baseline_mb()
    else:
    ...
    ver_file_path = (
        "submission_verification_toy.txt"
        if args.toy
        else "submission_verification.txt"
    )
